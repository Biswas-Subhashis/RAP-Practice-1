@AbapCatalog.sqlViewName: 'ZSORDVENDSB'
...
@EndUserText.label: 'RAP Practice SB - Interface CDS View'
define root view ZI_SORD_VENDORS_SB
  as select from ztsord_vendor_sb
{
